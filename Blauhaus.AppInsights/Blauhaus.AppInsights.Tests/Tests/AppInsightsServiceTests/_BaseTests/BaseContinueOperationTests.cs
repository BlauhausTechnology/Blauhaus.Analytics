...
namespace Blauhaus.AppInsights.Tests.Tests.AppInsightsServiceTests._BaseTests
{
    public abstract class BaseContinueOperationTests<TSut> : BaseAppInsightsTest<TSut> where TSut : BaseAppInsightsService
    {
        [Test]
