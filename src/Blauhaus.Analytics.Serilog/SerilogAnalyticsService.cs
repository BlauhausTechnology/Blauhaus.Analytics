...
{
    public class SerilogAnalyticsService : IAnalyticsService
    {
        private readonly IAnalyticsSessionFactory _analyticsSessionFactory;
        private IAnalyticsOperation? _currentOperation;
        private IAnalyticsSession? _currentSession;

        public SerilogAnalyticsService(
            IAnalyticsSessionFactory analyticsSessionFactory)
        {
            _analyticsSessionFactory = analyticsSessionFactory;
        }
        ...
        public IAnalyticsOperation StartPageViewOperation(object sender, string pageName = "", Dictionary<string, object> properties = null, string callingMember = "")
        {
            ...
            { 
                ...
                GetLogger(sender, properties)
                    .Verbose("PageView {PageName} completed in {Duration}", pageName, duration);
                _currentOperation = null;
            });
